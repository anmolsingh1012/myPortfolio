      ...
      <div className="container relative z-10">
        ...
        <div className="max-w-lg mx-auto">
          ...
          <p className="mt-4 text-center text-white/60 md:text-lg">
            A passionate Software Engineer skilled in C++, JavaScript, and
            React, with experience in building scalable web applications and
            reusable components. Eager to learn and adapt to new technologies
        ...
        <div className="flex flex-col md:flex-row justify-center items-center mt-8 gap-4">
          ...
          <a href="mailto:anmolsingh.as02@gmail.com">
            <button
              className="inline-flex items-center gap-2 border border-white
